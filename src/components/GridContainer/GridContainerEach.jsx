  ...
  return (
    <li>
      <Link className="grid-item">
        ...
        <img src={`../../assets/projectImages/${projectImage}.png` }alt="" />
        <div className="grid-item-title">
          <div className="grid-item-title-top">
            <h1 className="grid-item-title-top-head">{title}</h1>
...
export default GridContainerEach;
